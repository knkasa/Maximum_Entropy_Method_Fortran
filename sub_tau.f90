subroutine sub_tau( z, gap, numw, wmax, numnu, temp,  tau )
implicit none
...
double precision, dimension(1:numnu) :: tau
integer :: i, j, l, m, numw, numnu


T = temp*0.00008617d0  ! k*T  T=10 degree (see mycond.f95)************
pi = 3.141592654d0
beta = 1.0d0/T
dw = wmax/dfloat(numw)  
